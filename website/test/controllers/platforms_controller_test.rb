...
class PlatformsControllerTest < ActionController::TestCase
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post :create, platform: { kind: @platform.kind, name: @platform.name, token: @platform.token, user_id: @platform.user_id }
    end
  ...
  test "should update platform" do
    patch :update, id: @platform, platform: { kind: @platform.kind, name: @platform.name, token: @platform.token, user_id: @platform.user_id }
    assert_redirected_to platform_path(assigns(:platform))
  end
